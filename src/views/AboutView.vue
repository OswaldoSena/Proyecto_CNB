...
export default {
  ...
  data(){
    return {
      ...
      optionsDiploma: [
        ...
        { value: '/assets/img1.png', text: 'NORMAL'},
        { value: '/assets/img2.jpeg', text: 'HOMIL'},
        { value: '/assets/img3.jpg', text: 'TOMA MUESTRAS DE CITOLOGIA'},
        { value: '/assets/logo.png', text: 'CONGRESO CLAHT'}
      ],
      opcionConfiTexto:[
  ...
  methods:{
    ...
    SelectedImage() {
      this.imagenSeleccionada = this.SelectDiploma;
    },
  },
  computed:{
